...
public:
    ...
    D3D12_CPU_DESCRIPTOR_HANDLE Allocate(ID3D12Device* d3d12Device, uint32_t Count );
...
protected:
    ...
    static ID3D12DescriptorHeap* RequestNewHeap(ID3D12Device* d3d12Device, D3D12_DESCRIPTOR_HEAP_TYPE Type );
...
public:
    ...
    void Create(ID3D12Device* d3d12Device, const std::wstring& DebugHeapName, D3D12_DESCRIPTOR_HEAP_TYPE Type, uint32_t MaxCount );
