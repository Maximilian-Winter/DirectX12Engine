...
public:
    ...
    DynamicDescriptorHeap(Direct3D* OwningContext, D3D12_DESCRIPTOR_HEAP_TYPE HeapType);
    ~DynamicDescriptorHeap();

    void InitDynamicDescriptorHeap(Direct3D* OwningContext);
...
private:
    ...
    // Static methods
    static ID3D12DescriptorHeap* RequestDescriptorHeap(Direct3D* m_OwningContext, D3D12_DESCRIPTOR_HEAP_TYPE HeapType);
    ...
    struct DescriptorHandleCache
    {
        ...
        void CopyAndBindStaleTables( Direct3D* context, D3D12_DESCRIPTOR_HEAP_TYPE Type, uint32_t DescriptorSize, DescriptorHandle DestHandleStart, ID3D12GraphicsCommandList* CmdList,
