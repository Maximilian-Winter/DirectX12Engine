...
VS_OUTPUT GBufferDebugVertexShader(uint VertexID : SV_VertexID)
{
	VS_OUTPUT Output;
...
float4 GBufferDebugPixelShader(VS_OUTPUT In) : SV_TARGET
{
	...
	finalColor += float4(gbd.roughness, gbd.roughness, gbd.roughness, 0.0) * In.sampMask.wwww;
